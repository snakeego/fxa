      ...
      {isRevealed && (
        <div
          ...
          className={`w-full h-full fixed top-0 left-0 bg-white z-10
                      mobileLandscape:h-auto mobileLandscape:drop-down-menu mobileLandscape:top-10 mobileLandscape:-left-50`}
        >
          <div className="flex flex-wrap">
            <div className="flex w-full pt-4 items-center flex-col tablet:w-auto tablet:relative">
              <CloseIcon
                width="16"
                height="16"
                className="absolute top-6 right-6 tablet:hidden"
                onClick={closeFn}
              />
              <div className="mt-12 text-center p-8 pt-2 pb-2 tablet:mt-0">
